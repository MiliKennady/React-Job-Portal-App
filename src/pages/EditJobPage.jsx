...
const EditJobPage = ({updatedJobSubmit}) => {
    ...
    // creating an object with the new job details
    const updatedJob = {
      id,
      title,
      type,
    ...
    // after the new job details is submitted we need to go back to the job listing page , for that we use the useNavigate Hook
